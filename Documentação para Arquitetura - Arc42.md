...
C4Context
    title Diagrama de Contexto (Nível 1) - OrquestraCompras
    Person(user, "Cliente / Usuário Final", "Pessoa que busca itens, define orçamento e lojas de preferência.")
    System(matchmaker, "OrquestraCompras", "Sistema web inteligente que recebe os critérios do usuário, dispara agentes de IA para buscar produtos em e-commerces e retorna combos otimizados.")
    System_Ext(ecommerce, "Sites de E-commerce Alvo", "Plataformas de terceiros onde os agentes realizam as buscas de produtos.")
    System_Ext(ai_provider, "Provedor de LLM / IA", "APIs de Inteligência Artificial utilizadas para o parsing inteligente e raciocínio dos agentes.")
    Rel(user, matchmaker, "Configura o ambiente desejado, orçamento e lojas, e visualiza os combos", "HTTPS / Web")
    Rel(matchmaker, ai_provider, "Envia prompts e recebe análises estruturadas", "API REST")
    Rel(matchmaker, ecommerce, "Navega e extrai dados de produtos (preço, imagem, link)", "HTTP / Scraping")
